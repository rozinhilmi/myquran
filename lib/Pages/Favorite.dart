                              ...
                              ? Container(
                                  ...
                                  child: ListTile(
                                    onTap: () {
                                      Navigator.push(
                                          context,
                                          Transition(Surat(int.parse(
                                                  (listSurah[i]["nomor"])) -
                                              1)));
                                    },
                                    title: Text(
                                      listSurah[i]['nama'].toString(),
                                      style: TextStyle(
                                          color: isDark == true
                                              ? Colors.white
                                              : Colors.black),
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing: IconButton(
                                      onPressed: () {
                                        ...
                                        setState(() {
                                          setDataDoa(
                                              listDoa[i]['judul'].toString());
                                        });
                                      },
                                      icon: !favoriteDoa.contains(
                                              listDoa[i]['judul'].toString())
                                          ? Icon(Icons.favorite_border_rounded,
                                              size: 30)
                                          : Icon(
